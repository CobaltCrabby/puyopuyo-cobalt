...
const char* upvertexShaderSource = "#version 430 core\n"
...
const char* upfragmentShaderSource = "#version 430 core\n"
"out vec4 FragColor;\n"
"in vec2 TexCoord;\n"
"in vec4 ourColor;\n"
...
UIPuyo::UIPuyo(float x, float y, float size, enum color c) {
    color = c;
    switch (c) {
        case red:
            r = 1.0f;
...
void UIPuyo::drawInit(float x, float y, float size) {
    ...
    glShaderSource(vertexShader, 1, &upvertexShaderSource, NULL);
    glCompileShader(vertexShader);

    unsigned int fragmentShader = glCreateShader(GL_FRAGMENT_SHADER);
    glShaderSource(fragmentShader, 1, &upfragmentShaderSource, NULL);
